...
import ThankYouPage from "./user/ThankYou";
...
export default function ContactUs() {
  ...
  function contactus() {
    ...
    const url = `http://localhost:8080/api/user/feedback`;
        ...
        <div className="col">
          <div>
            <p>
              ...
              >
                <p>Email : MunchMate2024@gmail.com</p>
                <p>Address:Mumbai,Maharashtra </p>
                <p>Phone : 02164 228 800</p>
              </p>
              <header />
              <SocialFollow />
            </p>
