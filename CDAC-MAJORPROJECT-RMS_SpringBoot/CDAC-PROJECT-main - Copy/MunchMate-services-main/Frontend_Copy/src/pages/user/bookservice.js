...
import Images from "../../images/Extra1.jpg";
  ...
  <div style={styles.container1}>
    <div style={{ marginTop: 0 }}>
      <div style={styles.container}>
        <div className="mb-3">
          <h2 style={{ textAlign: "center", color: "black" , fontSize:50}}>
          ...
          <div className="col-d-lg-inline-flex">
            <div className="card-group" style={{ marginTop: 30, border: 1 }}>
              <div className="card-accordion-body">
                <h2 className="card-alert-heading" style={{color:"black", marginBottom:15}}>
                  {" "}{Service.serviceName}
                </h2>
