...
namespace WebApplication1.Controllers
{
    ...
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ServiceName,UserName,Email")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ServiceName,UserName,Email")] Booking booking)
        {
            if (id != booking.Id)
            {
                return NotFound();
